...
import { boardBodySchema, patchBoardSchema, boardListQuerySchema } from '../services/boardService'
...
const boards = new Hono<AppEnv>()
  .get('/', zValidator('query', boardListQuerySchema, zValidatorHook), getBoardsHandler)
